            ...
            <div className="settings-form">
              ...
              <div className="settings-form-section">
                ...
                <div className="av-mic-test-area">
                  ...
                  <button 
                    className={`av-toggle-btn ${isMicOk ? 'is-ready' : isMicTesting ? 'is-active' : ''}`}
                    onClick={isMicOk ? () => navigate(ROUTES.ACTIVITY) : handleToggleMicTest}
                    disabled={audioPermission === false && !isMicOk}
                  >
                    {isMicOk ? 'Start Training' : isMicTesting ? 'Stop Mic Test' : 'Start Mic Test'}
                  </button>
                </div>
              </div>
            </div>
