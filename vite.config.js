  ...
  server: {
    headers: {
      ...
      'Content-Security-Policy': [
        ...
        "img-src 'self' data: blob: https://assets.bigkas.site https://*.supabase.co",
        "media-src 'self' blob: https://assets.bigkas.site",
        "connect-src 'self' https://*.supabase.co https://*.hf.space wss://*.supabase.co ws://localhost:*",
        "frame-src 'none'",
        "object-src 'none'",
        "base-uri 'self'",
        "form-action 'self'",
  ...
  preview: {
    headers: {
      ...
      'Content-Security-Policy': [
        ...
        "img-src 'self' data: blob: https://assets.bigkas.site https://*.supabase.co",
        "media-src 'self' blob: https://assets.bigkas.site",
        "connect-src 'self' https://*.supabase.co https://*.hf.space wss://*.supabase.co",
        "frame-src 'none'",
        "object-src 'none'",
        "base-uri 'self'",
        "form-action 'self'",
