...
export default function TestAudioVideoPageMobile() {
  ...
  return (
    <div className="settings-profile-page settings-profile-page--preferences dashboard-page-new test-audio-video-mobile">
      <div className="settings-profile-container">
        ...
        <div className={`profile-hero-card profile-hero-card--preferences hero-theme--${heroTheme}`}>
          ...
          <div className="hero-info hero-info--preferences">
            ...
            <p className="hero-email">Test your camera and microphone for the best training experience.</p>
          </div>
        </div>

        <div className="settings-content-wrapper">
          <div className="settings-main-card sp-preferences-card test-av-mobile-card">
            <div className="settings-form test-av-mobile-form">
                ...
                <div className="av-camera-viewport">
                  {cameraPermission !== false ? (
                    ...
                    <div className="av-error-placeholder">
                      <p>Camera access was denied. Check your browser settings.</p>
                    </div>
                  )}
                </div>

                {cameraPermission !== false && (
                  <button type="button" className="test-av-flip-btn" onClick={handleFlipCamera}>
                    <IoCameraReverseOutline aria-hidden />
                    Flip camera
                  </button>
                )}
              </div>

              <div className="settings-divider test-av-mobile-divider" />
