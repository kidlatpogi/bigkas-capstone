import{j as e,A as c,m as i}from"./vendor-motion-BXP49Ir3.js";import"./vendor-framework-gCbw6FxD.js";import{u as t}from"./styled-components.browser.esm-DWO9IDTp.js";const l=t(i.div)`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,A=({isOpen:o,onClose:a,title:r,content:n})=>e.jsx(c,{children:o&&e.jsx(l,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:a,children:e.jsxs(d,{initial:{scale:.9,opacity:0,y:20},animate:{scale:1,opacity:1,y:0},exit:{scale:.9,opacity:0,y:20},onClick:s=>s.stopPropagation(),children:[e.jsx(p,{children:e.jsx(u,{children:r})}),e.jsx(h,{children:n}),e.jsx(y,{children:e.jsx(f,{onClick:a,children:"Close"})})]})})}),x=`
...
`;export{A as L,v as P,x as T};
//# sourceMappingURL=privacy-Os564juB.js.map
