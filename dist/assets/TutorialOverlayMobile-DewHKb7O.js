import{r,j as o,b as Et}from"./vendor-framework-CmdwDIpY.js";import{F as Tt,h as kt}from"./vendor-icons-extra-Fue5dvCh.js";import{a as pt,b as N}from"./assetUtils-GXo6Kztt.js";import{u as It}from"./index-D4dY7Lla.js";/* empty css                        */import"./vendor-icons-core-Cyee2-Zc.js";import"./vendor-supabase-DaITVRM7.js";const Pt=pt("Robot/0008-noBulb-inverted.png"),At=N("Profiling and Pre-Testing/Pre-Testing Tutorial/pre-testing tutorial 1.mp3"),jt=N("Profiling and Pre-Testing/Pre-Testing Tutorial/pre-testing tutorial 2.mp3"),Mt=N("Profiling and Pre-Testing/Pre-Testing Tutorial/pre-testing tutorial 3.mp3"),Rt="https://assets.bigkas.site/Voices/Profiling%20and%20Pre-Testing/Pre-Testing%20Tutorial/pre-testing%20tutorial%204_new.mp3",Bt=N("Profiling and Pre-Testing/Pre-Testing Tutorial/pre-testing tutorial 5.mp3"),Lt=N("Profiling and Pre-Testing/Pre-Testing Tutorial/pre-testing tutorial FINAL.mp3"),Nt=pt("Robot/0002.webp"),mt="https://assets.bigkas.site/Images/Bigkas-Logo.webp",Vt="Your Streak counter tracks how many consecutive days you've practiced. Consistency is the true secret to mastering public speaking! Log in and complete a daily activity to keep the fire burning and watch that number grow.",_t="https://assets.bigkas.site/Voices/Home%20Page/Tutorials/Streak-Counter.mp3",Ft="https://assets.bigkas.site/Voices/Home%20Page/Tutorials/Voice%202%20-%20Steak-Counter.mp3",Ct=Array.from({length:32},(s,h)=>h),dt=r.memo(({text:s,fullText:h,isDone:B,emphasis:c})=>{if(!B)return o.jsx(o.Fragment,{children:s});if(!c)return o.jsx(o.Fragment,{children:h});const E=h.indexOf(c);if(E<0)return o.jsx(o.Fragment,{children:h});const V=h.slice(0,E),H=h.slice(E+c.length);return o.jsxs(o.Fragment,{children:[V,o.jsx("strong",{className:"tutorial-bubble-emphasis",children:c}),H]})});dt.displayName="TypingText";function $t({isOpen:s,onClose:h,onFinish:B,steps:c=null,robotImage:E=Pt,finalRobotImage:V=Nt,showAudioToggle:H=!1,onCloseDashboard:k=void 0}){const{user:m,updateUserMetadata:bt}=It(),J="bigkas_global_audio_muted_v1",Q=r.useMemo(()=>[{id:"step-intro",title:"B-01:",text:"Before we jump in, let's do a quick walkthrough of how this works! Ready to get started?",button:"Continue",targetElementId:null},{id:"step-topic",title:"B-01:",text:"'The Topic' This is for your Verbal analysis! Focus on the prompt shown here to ensure your content is clear and stays on track.",button:"Continue",targetElementId:"tutorial-target-topic",emphasis:"'The Topic'"},{id:"step-camera",title:"B-01:",text:"'The Camera View' This is for your Visual analysis! Position yourself within the guide so I can accurately track your eye contact, expressions, and gestures. Also, make sure you're in a well-lit room so I can see you clearly—good lighting makes for a great performance!",button:"Next",targetElementId:"tutorial-target-camera",emphasis:"'The Camera View'"},{id:"step-soundbar",title:"B-01:",text:"'Voice Meter' This is for your Vocal analysis! Watch the soundbar dance as you speak to see your projection and emotional expression.",button:"Next",targetElementId:"tutorial-target-soundbar",emphasis:"'Voice Meter'"},{id:"step-controls",title:"B-01:",text:"'The Controls', Use Start to begin, Pause if you need a breather, or Restart to try the topic again from the top!",button:"Next",targetElementId:"tutorial-target-controls",emphasis:"'The Controls'"},{id:"step-final",title:"B-01:",text:"Controls mastered! Yay! Whenever you're ready, click Start so I can hear what you've got. I'm so excited to listen!",button:"BEGIN!",targetElementId:null}],[]),q=r.useMemo(()=>Array.isArray(c)&&c.length>0?c:Q,[Q,c]),_=r.useMemo(()=>!(Array.isArray(c)&&c.length>0),[c]),f=Array.isArray(c)&&c.length>0,[w,tt]=r.useState(0),[x,D]=r.useState(0),[ht,Y]=r.useState(""),[G,K]=r.useState(!1),[p,ft]=r.useState(()=>typeof window!="undefined"&&window.matchMedia("(max-width: 768px)").matches),[d,et]=r.useState(()=>typeof window=="undefined"?!1:m&&typeof m.isAudioMuted=="boolean"?m.isAudioMuted:window.localStorage.getItem(J)==="1"),[L,F]=r.useState(null);r.useEffect(()=>{if(typeof window=="undefined")return;const e=window.matchMedia("(max-width: 768px)"),i=()=>ft(e.matches);return typeof e.addEventListener=="function"?(e.addEventListener("change",i),()=>e.removeEventListener("change",i)):(e.addListener(i),()=>e.removeListener(i))},[]),r.useEffect(()=>{m&&typeof m.isAudioMuted=="boolean"&&et(m.isAudioMuted)},[m==null?void 0:m.isAudioMuted]);const n=r.useRef(null),rt=r.useRef(null),T=r.useRef([]),y=r.useRef(null),l=r.useRef(null),S=r.useRef(!1),W=r.useRef(!1),ot=r.useRef(d);r.useEffect(()=>{ot.current=d},[d]);const[I,X]=r.useState(null),t=r.useMemo(()=>q[w],[q,w]),C=r.useMemo(()=>t!=null&&t.text?t.textPart2&&x===1?t.textPart2:p&&t.id==="step-streak"?Vt:t.text:"",[t,p,x]),O=r.useMemo(()=>{var e;return t?p&&t.id==="step-streak"?(localStorage.getItem("bigkas_b01_voice")||"voice1")==="voice2"?Ft:_t:x===1&&t.voicePart2?t.voicePart2:x===1?null:(e=t.voice)!=null?e:null:null},[t,p,x]),it=r.useMemo(()=>t?t.robot||(t.id==="step-final"?V:E):E,[t,V,E]),gt=(t==null?void 0:t.id)==="step-intro"||(t==null?void 0:t.id)==="step-companion",P=!!(!f&&p&&(t==null?void 0:t.id)!=="step-final"||f&&((t==null?void 0:t.id)==="step-streak"||p&&!gt)),wt=r.useMemo(()=>P?mt:it,[P,it]),$=(t==null?void 0:t.targetElementId)==="tutorial-target-home-streak"||(t==null?void 0:t.targetElementId)==="tutorial-target-home-rank"||(t==null?void 0:t.targetElementId)==="tutorial-target-home-practice",at=(t==null?void 0:t.id)==="step-streak",Z=()=>{typeof document!="undefined"&&document.querySelectorAll(".tutorial-spotlight-active").forEach(e=>{e.classList.remove("tutorial-spotlight-active")})},A=()=>{T.current.forEach(e=>{e&&(e.pause(),e.currentTime=0)}),y.current&&(y.current.pause(),y.current.currentTime=0,y.current=null)},nt=(e,i="B-01 voice")=>{e&&(e.muted=!1,e.currentTime=0,e.onerror=()=>{console.warn(`[TutorialOverlayMobile] ${i} unavailable.`)},e.play().catch(a=>{console.warn(`[TutorialOverlayMobile] ${i} play failed:`,a)}))},xt=()=>{et(e=>{const i=!e;return typeof window!="undefined"&&window.localStorage.setItem(J,i?"1":"0"),m!=null&&m.id&&bt({is_audio_muted:i}).catch(()=>{}),i&&A(),i})};if(r.useEffect(()=>{if(!_){T.current=[];return}return T.current=[new Audio(At),new Audio(jt),new Audio(Mt),new Audio(Rt),new Audio(Bt),new Audio(Lt)],T.current.forEach(e=>{e&&(e.preload="none")}),()=>{A(),T.current=[]}},[_]),r.useEffect(()=>{T.current.forEach(e=>{e&&(e.muted=d,d&&(e.pause(),e.currentTime=0))}),y.current&&(y.current.muted=d,d&&(y.current.pause(),y.current.currentTime=0))},[d]),r.useEffect(()=>{if(s){W.current=!0,Z(),tt(0),D(0);return}W.current&&k&&f&&p&&k(),W.current=!1,Z(),A(),l.current&&(window.clearInterval(l.current),l.current=null),n.current&&(n.current.classList.remove("tutorial-spotlight-active"),n.current.style.removeProperty("pointer-events"),n.current=null)},[s,k,f,p]),r.useEffect(()=>{D(0)},[w]),r.useEffect(()=>{S.current=!1},[w]),r.useEffect(()=>{var j;if(!s||!t)return;const e=t.targetElementId;if(e!=="tutorial-target-home-streak"&&e!=="tutorial-target-home-rank"&&e!=="tutorial-target-home-practice"||typeof document=="undefined"||document.getElementById(e)||S.current)return;const i=document.querySelector(".activity-mobile-dashboard-section"),a=i==null?void 0:i.querySelector("button.activity-mobile-dashboard-btn"),b=(j=a==null?void 0:a.textContent)==null?void 0:j.trim().toLowerCase();a&&b==="dashboard"&&(a.click(),S.current=!0)},[s,t==null?void 0:t.id,t==null?void 0:t.targetElementId,w]),r.useEffect(()=>{if(!s||!t)return;Z(),n.current&&(n.current.classList.remove("tutorial-spotlight-active"),n.current.style.removeProperty("z-index"),n.current.style.removeProperty("pointer-events"),n.current=null);const e=t==null?void 0:t.targetElementId,i=f&&e==="tutorial-target-home-journey"?"4600":"4800",a=e==="tutorial-target-home-streak"||e==="tutorial-target-home-rank"||e==="tutorial-target-home-practice",b=e==="tutorial-target-home-streak"||e==="tutorial-target-home-rank"||e==="tutorial-target-home-practice",j=a?48:6,v=a?80:60;let M=!1,R=null;const z=(U=0)=>{if(M||!e)return;const g=document.getElementById(e);if(g){if(g.classList.add("tutorial-spotlight-active"),g.style.setProperty("z-index",i,"important"),b&&g.style.setProperty("pointer-events","none","important"),n.current=g,e==="tutorial-target-home-practice"){const u=document.querySelector(".dashboard-overlay-scroll-content")||document.querySelector(".dashboard-overlay-content");if(u){try{u.scrollTo({top:u.scrollHeight,behavior:"smooth"})}catch{u.scrollTop=u.scrollHeight}setTimeout(()=>{u&&(u.scrollTop=u.scrollHeight)},60)}}else if(e==="tutorial-target-home-journey")try{const u=g.querySelector(".skyward-journey-node--active");u?u.scrollIntoView({behavior:"smooth",block:"center"}):g.scrollIntoView({behavior:"smooth",block:"start"})}catch{}else try{g.scrollIntoView({behavior:"smooth",block:"center"})}catch{}return}U>=j||(R=window.setTimeout(()=>z(U+1),v))};return e&&z(0),()=>{M=!0,R&&window.clearTimeout(R),n.current&&(n.current.classList.remove("tutorial-spotlight-active"),n.current.style.removeProperty("z-index"),n.current.style.removeProperty("pointer-events"),n.current=null)}},[s,t==null?void 0:t.targetElementId,f]),r.useEffect(()=>{if(!s||(t==null?void 0:t.targetElementId)!=="tutorial-target-soundbar"){F(null);return}let e=0;const i=()=>{e=window.requestAnimationFrame(()=>{const a=document.getElementById("tutorial-target-soundbar");if(!a){F(null);return}const b=a.getBoundingClientRect();F({top:b.top,left:b.left,width:b.width,height:b.height})})};return i(),window.addEventListener("resize",i),window.addEventListener("scroll",i,!0),()=>{e&&window.cancelAnimationFrame(e),window.removeEventListener("resize",i),window.removeEventListener("scroll",i,!0),F(null)}},[s,t==null?void 0:t.targetElementId]),r.useEffect(()=>{!s||!p||!f||!k||(t==null?void 0:t.targetElementId)==="tutorial-target-home-journey"&&k()},[s,p,f,t==null?void 0:t.targetElementId,w,x,k]),r.useEffect(()=>{if(!s||!t){X(null);return}if(!(!(!f&&p&&(t.id==="step-controls"||t.id==="step-soundbar"))&&(t.id==="step-controls"||t.id==="step-soundbar"||t.id==="step-roadmap"||t.id==="step-practice"))){X(null);return}let a=0,b=0;const j=()=>{const M=t.targetElementId?document.getElementById(t.targetElementId):null,R=rt.current;if(!M||!R)return!1;const z=M.getBoundingClientRect(),U=R.getBoundingClientRect(),g=parseFloat(window.getComputedStyle(document.documentElement).fontSize)||16,u=t.id==="step-roadmap"?g:0,ct=g*2+u,vt=Math.max(8,z.top-U.height-ct);return X({top:`${vt}px`,bottom:"auto",zIndex:5100}),!0},v=()=>{a=window.requestAnimationFrame(()=>{j()||(b=window.setTimeout(v,60))})};return v(),window.addEventListener("resize",v),window.addEventListener("orientationchange",v),()=>{a&&window.cancelAnimationFrame(a),b&&window.clearTimeout(b),window.removeEventListener("resize",v),window.removeEventListener("orientationchange",v)}},[s,t==null?void 0:t.id,t==null?void 0:t.targetElementId,x,f,p]),r.useEffect(()=>{if(!s||!t)return;Y(""),K(!1),l.current&&(window.clearInterval(l.current),l.current=null);let e=0;const i=C;if(l.current=window.setInterval(()=>{e+=1,Y(i.slice(0,e)),e>=i.length&&(l.current&&(window.clearInterval(l.current),l.current=null),K(!0))},12),!ot.current){if(A(),O){const a=new Audio(O);y.current=a,nt(a,"Custom voice")}else if(_){const a=T.current[w];a&&nt(a,`Tutorial voice ${w+1}`)}}return()=>{l.current&&(window.clearInterval(l.current),l.current=null),A()}},[w,s,_,t==null?void 0:t.id,C,O,x]),!s||!t)return null;const yt=()=>{if(A(),!G){Y(C),K(!0),l.current&&(window.clearInterval(l.current),l.current=null);return}if(t.textPart2&&x===0){D(1);return}if(w>=q.length-1){n.current&&(n.current.classList.remove("tutorial-spotlight-active"),n.current.style.removeProperty("z-index"),n.current.style.removeProperty("pointer-events"),n.current=null),B==null||B(),h==null||h();return}tt(i=>i+1)},st=`tutorial-overlay-wrapper${f?" is-custom-tutorial":" is-default-tutorial"}${(t==null?void 0:t.id)==="step-controls"?" is-controls-step":""}${(t==null?void 0:t.id)==="step-soundbar"?" is-soundbar-step":""}${(t==null?void 0:t.id)==="step-final"?" is-final-step":""}${(t==null?void 0:t.id)==="step-rank"?" is-rank-step":""}${t!=null&&t.robotClassName?` ${t.robotClassName}`:""}`,lt=o.jsx(o.Fragment,{children:o.jsxs("div",{className:"tutorial-companion-container",ref:rt,style:$?{...I!=null?I:{},pointerEvents:"auto"}:I!=null?I:void 0,children:[P?null:o.jsx("img",{src:wt,alt:"",className:"tutorial-robot-img","aria-hidden":"true"}),o.jsxs("article",{className:`tutorial-speech-bubble${P?" tutorial-speech-bubble--logo":""}`,children:[o.jsx("div",{className:`tutorial-bubble-title${P?" tutorial-bubble-title--with-brand":""}`,children:P?o.jsxs(o.Fragment,{children:[o.jsx("img",{src:mt,alt:"",className:"tutorial-bubble-title-logo",width:36,height:36}),o.jsx("span",{className:"tutorial-bubble-title-label",children:t.title})]}):t.title}),o.jsx("p",{className:"tutorial-bubble-text",children:o.jsx(dt,{text:ht,fullText:C,isDone:G,emphasis:x===0?t.emphasis:void 0})}),o.jsxs("div",{className:"tutorial-bubble-footer",children:[H&&o.jsx("button",{type:"button",onClick:xt,"aria-label":d?"Unmute B-01 voice":"Mute B-01 voice",title:d?"Unmute B-01 voice":"Mute B-01 voice",className:`tutorial-audio-toggle ${d?"is-muted":"is-unmuted"}`,children:d?o.jsx(Tt,{"aria-hidden":"true"}):o.jsx(kt,{"aria-hidden":"true"})}),o.jsx("button",{type:"button",className:"tutorial-bubble-btn",onClick:yt,disabled:!G,children:t.button})]})]})]})}),ut=$&&typeof document!="undefined"?Et.createPortal(o.jsxs(o.Fragment,{children:[at?o.jsx("div",{className:"bigkas-modal-scrim bigkas-modal-scrim--no-enter tutorial-mobile-streak-scrim","aria-hidden":"true",style:{position:"fixed",inset:0,zIndex:1800,pointerEvents:"none",background:"rgba(15, 23, 42, 0.5)",backdropFilter:"blur(4px)",WebkitBackdropFilter:"blur(4px)"}}):null,o.jsx("div",{className:st,style:{position:"fixed",inset:0,zIndex:7200,pointerEvents:"none"},"aria-label":"Training tutorial overlay",children:lt})]}),document.body):null;return o.jsxs(o.Fragment,{children:[s&&at?o.jsx("style",{children:`
          /*
      ...
      `}),$&&ut?ut:o.jsx("section",{className:st,"aria-label":"Training tutorial overlay",children:lt})]})}const Kt=r.memo($t);export{Kt as default};
