...
print("\n2. Testing POST /banner-message ...")
b_res = httpx.post(f"{base_url}/banner-message", json={"context": {"currentLevel": 1, "levelName": "Novice"}}, timeout=15.0)
print(f"   Status: {b_res.status_code}, Response: {b_res.text}")

print("\n3. Testing GET /random-topic ...")
